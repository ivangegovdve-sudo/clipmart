...
export default function BrowsePage() {
  return (
    // ⚡ Bolt: Wrapped BrowseContent in <Suspense> to prevent useSearchParams() from
    // bailing out the entire /browse route from Next.js static generation (SSG).
    // Impact: Enables static rendering of the page shell, reducing TTFB (Time to First Byte)
    // from typical SSR times (~100-300ms+) to CDN static edge delivery (~10-50ms).
